...
if __name__ == "__main__":
    ...
    # Limitamos n_jobs=4 en esta fase porque process_dDTF_global consume muchísima RAM
    Parallel(n_jobs=4)(delayed(load_and_compute_ddtf)(p) for p in set(all_paths))
